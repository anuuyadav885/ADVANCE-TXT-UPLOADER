...
OWNER_ID = 6127347210 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [6127347210,6395950392]

AUTH_CHANNEL = -1002584614736
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/taporibot_bot") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/+fK5x8NgiYKQ0ZThl") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/+fK5x8NgiYKQ0ZThl")                              
                ],           
            ]
      )
...
"https://i.ibb.co/Xx7yBMv5/file-996.jpg",
"https://i.ibb.co/bjxPjmn3/file-994.jpg",
"https://i.ibb.co/Xfsd942p/file-993.jpg",
"https://i.ibb.co/TykvkL0/file-990.jpg",
"https://i.ibb.co/fY6tn26d/file-989.jpg",
"https://i.ibb.co/DD81R9Xc/file-995.jpg",
"https://i.ibb.co/mC9h9HJH/file-997.jpg",
"https://i.ibb.co/7dzmQF2V/file-998.jpg",
"https://i.ibb.co/S7BTdFzy/file-1001.jpg",
"https://i.ibb.co/fz83pJVv/file-1002.jpg",
"https://i.ibb.co/3LLTQkw/file-859.jpg",
"https://i.ibb.co/273kGBKs/file-866.jpg",
"https://i.ibb.co/ccn63XDh/file-867.jpg",
"https://i.ibb.co/5xYgK22K/file-851.jpg",
"https://i.ibb.co/MxqsJcXz/file-852.jpg",
"https://i.ibb.co/HyvSSBS/file-853.jpg",
"https://i.ibb.co/Z6rnZp2S/file-854.jpg",
"https://i.ibb.co/xSYpmc1k/file-855.jpg",
"https://i.ibb.co/6JyHG8Jt/file-856.jpg",
"https://i.ibb.co/0ph0YP8S/file-857.jpg",
"https://i.ibb.co/ksqm3G3k/file-858.jpg",
"https://i.ibb.co/XkJYSMQL/file-860.jpg",
"https://i.ibb.co/XrQTPnZ5/file-861.jpg",
"https://i.ibb.co/Rkp2PRSG/file-862.jpg",
"https://i.ibb.co/fYbBfzF9/file-865.jpg",
...
@bot.on_message(filters.command("rukjaa"))
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/tapori` - Download and upload files (sudo)🎬\n\n"
        "`/restart` - Restart the bot🔮\n\n" 
        "`/rukjaa` - Stop ongoing process🛑\n\n"
...
@bot.on_message(filters.command(["tapori"]))
async def upload(bot: Client, m: Message):
    ...
    await editable.edit("📛 𝔼ɴᴛᴇʀ Your Name 📛\n\n🐥 𝗦𝗲𝗻𝗱 `1` 𝗙𝗼𝗿 𝗨𝘀𝗲 𝗗𝗲𝗳𝗮𝘂𝗹𝘁 🐥")
    input3: Message = await bot.listen(editable.chat.id)
    raw_text3 = input3.text
    await input3.delete(True)
    # Default credit message with link
    credit = "️[𝗧𝗮𝗽𝗼𝗿𝗶 𝟮.𝟬🥷](https://t.me/taporibot_bot)"
    if raw_text3 == '1':
        CR = '[𝗧𝗮𝗽𝗼𝗿𝗶 𝟮.𝟬🥷](https://t.me/taporibot_bot)'
    elif raw_text3:
        try:
    ...
    await editable.edit("𝗡𝗼𝘄 𝗦𝗲𝗻𝗱 𝗧𝗵𝗲 𝗧𝗵𝘂𝗺𝗯 𝗨𝗿𝗹 𝗘𝗴 » https://i.ibb.co/V0NnQFGP/file-881.jpg\n\n𝗢𝗿 𝗜𝗳 𝗗𝗼𝗻'𝘁 𝗪𝗮𝗻𝘁 𝗧𝗵𝘂𝗺𝗯𝗻𝗮𝗶𝗹 𝗦𝗲𝗻𝗱 = 𝗻𝗼")
